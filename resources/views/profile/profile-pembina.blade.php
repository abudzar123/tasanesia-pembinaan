          ...
          <div class="card" style="background-color: white; margin-top: 85px; border: none">
            ...
            <div class="card-body">
              <div class="row" style="padding: 35px">
                @foreach ($profile_pembina as $profile)   
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>ID institusi :</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>{{$profile->institution_id }}</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>Posisi organisasi:</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>{{$profile->position_in_org}}</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>Nama :</h5>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>{{$profile->project_name}}</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>Gelar :</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>{{$profile->degree }}</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>Posisi Projek :</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>{{$profile->position_in_project }}</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>Sekolah :</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>{{$profile->school }}</h5>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mt-3 form-coloumn">
                  <h5>Skill :</h5>
                </div>
